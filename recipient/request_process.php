...
AND id NOT IN (SELECT donation_id FROM requests);";
                ...
                <tbody>
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<button type='submit' name='accept'><i class='fa-solid fa-check' style='color: #398e1a;'></i>Request</button>";
                            echo "<button type='submit' name='reject'><i class='fa-solid fa-times' style='color: #f00;'></i>Cancel</button>";
                            echo "</form>";
                            echo "</td>";
                            echo "</tr>";
                            echo "</tr>";
